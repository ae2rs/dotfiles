# Source: https://github.com/can1357/oh-my-pi (packages/coding-agent/src/edit/hashline-compact.md)
# License: MIT — upstream's compact variant of the model-facing hashline contract.
# Vendored because the @oh-my-pi/hashline npm package ships only the full prompt.md.
